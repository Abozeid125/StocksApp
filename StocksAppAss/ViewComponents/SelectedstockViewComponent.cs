...
namespace StockMarketSolution.ViewComponents
{
    public class SelectedStockViewComponent : ViewComponent
    {
        ...
        private readonly IStockServices _stocksService;
        ...
        public SelectedStockViewComponent(IOptions<TradingOptions> tradingOptions, IStockServices stocksService, IFinnHubService finnhubService, IConfiguration configuration)
        {
